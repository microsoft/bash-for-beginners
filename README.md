...
- [Quickstart for Bash in Azure Cloud Shell](https://learn.microsoft.com/azure/cloud-shell/quickstart/)
- [Learn to use Bash with the Azure CLI](https://learn.microsoft.com/cli/azure/azure-cli-learn-bash)
- [Create a Linux virtual machine in Azure](https://learn.microsoft.com/training/modules/create-linux-virtual-machine-in-azure/)
